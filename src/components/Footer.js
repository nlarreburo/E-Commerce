...
export const Footer = () => {
  return (
      ...
      <footer className="footer footer-center p-10 bg-rose-900 text-primary-content relative bottom-0">
          <div>
              ...
              Merceria Variedades <br/>Llevando felicidad a las familias desde 2010
              </p> 
